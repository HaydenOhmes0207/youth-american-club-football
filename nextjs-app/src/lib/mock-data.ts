...
export const mockNavItems = [
  ...
  },
  {
    ...
    is_active: true,
    children: [
      { id: 'nav-2-1', organization_id: 'org-1', parent_id: 'nav-2', label: 'Manage Teams', href: '/teams/manage', icon: null, order: 1, is_active: true },
      { id: 'nav-2-2', organization_id: 'org-1', parent_id: 'nav-2', label: 'Assignments', href: '/teams/assignments', icon: null, order: 2, is_active: true },
    ],
  },
  {
    id: 'nav-3',
