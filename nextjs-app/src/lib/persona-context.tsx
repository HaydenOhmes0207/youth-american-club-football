...
const personas: Record<PersonaId, Persona> = {
  ...
  maria: {
    ...
    description: 'Jeff is a youth AmFB club director managing 40 teams across football and cheer. He coordinates facilities and manages a robust registration pipeline.',
  },
};
