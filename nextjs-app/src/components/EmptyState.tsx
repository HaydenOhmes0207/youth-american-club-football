...
export type EmptyStateVariant = 
  | 'programs' | 'programs-draft' | 'programs-archived'
  | 'teams' | 'teams-season' | 'teams-athletes' | 'teams-parents' | 'teams-staff'
  | 'tickets-events' | 'tickets-events-published' | 'tickets-events-non-ticketed' | 'tickets-events-draft' | 'tickets-events-past'
  | 'tickets-passes' | 'tickets-passes-current' | 'tickets-passes-draft' | 'tickets-passes-past'
  | 'search';
...
const contentMap: Record<EmptyStateVariant, { title: string; description: string; icon: React.ReactNode }> = {
  'programs': { title: 'No programs yet', description: 'Create your first program to start managing registrations, tryouts, and events.', icon: <PlusIcon /> },
  'programs-draft': { title: 'No draft programs', description: "Programs you're still working on will appear here. Start a new program to save it as a draft.", icon: <DraftIcon /> },
  'programs-archived': { title: 'No archived programs', description: 'Completed or inactive programs will appear here when you archive them.', icon: <ArchiveIcon /> },
  'teams': { title: 'No teams yet', description: 'Create teams to organize your athletes into groups for the season.', icon: <UsersIcon /> },
  'teams-season': { title: 'No teams for this season', description: 'Click "Manage Teams" to create new teams or copy from a previous season.', icon: <CalendarIcon /> },
  'teams-athletes': { title: 'No athletes yet', description: 'Athletes will appear here once teams are provisioned.', icon: <UsersIcon /> },
  'teams-parents': { title: 'No family members yet', description: 'Family members will appear here once teams are provisioned.', icon: <UsersIcon /> },
  'teams-staff': { title: 'No staff yet', description: 'Staff members will appear here once they are added to your organization.', icon: <UsersIcon /> },
  'tickets-events': { title: 'No events yet', description: 'Create your first ticketed event to start selling tickets.', icon: <TicketIcon /> },
  'tickets-events-published': { title: 'No published events', description: 'Published events with active ticket sales will appear here.', icon: <TicketIcon /> },
  'tickets-events-non-ticketed': { title: 'No non-ticketed events', description: 'Events without ticket sales enabled will appear here.', icon: <CalendarIcon /> },
  'tickets-events-draft': { title: 'No draft events', description: "Events you're still setting up will appear here.", icon: <DraftIcon /> },
  'tickets-events-past': { title: 'No past events', description: 'Completed events will appear here after their end date.', icon: <ArchiveIcon /> },
  'tickets-passes': { title: 'No passes yet', description: 'Create season passes or multi-game packages.', icon: <CreditCardIcon /> },
  'tickets-passes-current': { title: 'No current passes', description: 'Active season passes will appear here.', icon: <CreditCardIcon /> },
  'tickets-passes-draft': { title: 'No draft passes', description: "Passes you're still setting up will appear here.", icon: <DraftIcon /> },
  'tickets-passes-past': { title: 'No past passes', description: 'Expired or completed passes will appear here.', icon: <ArchiveIcon /> },
  'search': { title: 'No results found', description: 'Try adjusting your search terms or check for typos.', icon: <SearchIcon /> },
};
